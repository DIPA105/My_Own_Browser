...
contacts = ['dipaghosh566@gmail.com' ,"dipaghosh299@gmail.com"]
msg = EmailMessage()
msg['Subject'] = 'Weekend Special'
msg['From'] = 'dipaghosh566@gmail.com'
msg['To'] = ', '.join(contacts)
msg.set_content('Check out the list of all best Weekend Special restaurants near you in Chetla, Kolkata and book through Dineout to get various offers, discounts')
print(msg)

with open('S.png', 'rb') as m:
    file_data = m.read()
...
with smtplib.SMTP_SSL('smtp.gmail.com', 465) as smtp:
    smtp.login('dipaghosh566@gmail.com', '***********')
